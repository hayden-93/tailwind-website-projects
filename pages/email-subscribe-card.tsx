    ...
    <div className='flex items-center justify-center h-screen bg-zinc-700'>
      <div className='bg-zinc-800 p-2 mx-6 rounded-2xl'>
        <div className='flex flex-col md:flex-row rounded-l-xl'>
          <Image
            src='/images/email-subscribe-card/emailsubimage.jpeg'
            alt='Peas in bowl image'
            width={200}
            height={200}
            className='object-fit rounded-xl h-80 sm:w-full md:h-72 md:rounded-l-xl md:rounded-r-none transform hover:scale-105 hover:rounded-xl duration-200'
          />
